package ua.lviv.iot.bus.persistant;
...
public class ConnectionManager {
  private static final String url = "jdbc:mysql://localhost:3306/osadchuk?useUnicode"
      + "=true&serverTimezone=UTC&useSSL=false&allowPublicKeyRetrieval=true";

  private static final String username = "root";

  private static final String password = "160702Op160702Op";
